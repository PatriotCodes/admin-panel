...
<div class="container">
  <form class="form-control mt-4" method="post">
  		<div class="form-row mb-3">
      		<input type="text" class="form-control mt-2" name="categoryName" placeholder="Название группы" 
          value="<?php echo $categoryName['categoryName'] ?>" required>
      	</div>
      		<?php if($success) {
      		echo '<div class="form-row"><div class="col-md-8">
      			<div class="alert alert-success mb-2">
  					Данные успешно обновлены! Вы будете автоматически возвращены на страницу <a href="./groups.php" class="alert-link">групп</a>.</div></div><div class="col-md-4">';
      		} ?>
