...
<div class="container">
    <form class="form-control mt-4" method="post">
    	<div class="form-row">
        	...
        	<div class="col-md-6 mb-3">
      			<input type="text" class="form-control mt-1" id="actionString" name="path" placeholder="Путь к исполняемому файлу или гиперссылка" required>
      		</div>
      	</div>
      	<div class="form-row">
      		<div class="col-md-6 mb-3">
      ...
      <?php if($success) {
          echo '<div class="form-row"><div class="col-md-8">
            ...
            Новый ресурс был успешно добавлен!
